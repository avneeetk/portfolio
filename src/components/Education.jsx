...
const Details = ({ type, time, place, info }) => {
    ...
    return( <li ref={ref} className='my-8 first:mt-0 last:mb-0 w-[60%] mx-auto flex flex-col items-center justify-between'>
        ...
        transition={{duration:0.5, type:'spring'}}>
                <h3 className="capitalize font-bold text-xl sm:text-2xl">{type}</h3>
                <span className='capitalize font-medium text-dark/75 text-sm sm:text-base'>
                    {time} | {place}
                </span>
                <p className="font-medium w-full text-sm sm:text-base mt-2">
                    {info}
                </p>
            </motion.div>
        </li>
            ...
            <div ref={ref} className='w-[75%] mx-auto relative'>
                ...
                <ul className='w-full flex flex-col items-start justify-between mb-32 font-mono'>
                    ...
                    <Details
                        ...
                        time="2022-2026"
                        place="Guru Tegh Bahadur Institute of Technology (GGSIPU)"
                        info="Delving into the world of algorithms, programming, and software development, I've been expanding my technical skills and understanding of computer science fundamentals. This degree has honed my problem-solving abilities and fueled my passion for building user-friendly digital solutions."
                    />
                    <Details
                        type="High School, (Class XII: 90%)"
                        time="2020-2022"
                        place="Guru Harkrishan Public School, Vasant Vihar"
