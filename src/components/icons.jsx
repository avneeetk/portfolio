...
export const GmailIcon = ({ className, ...rest }) => (
    <svg
      ...
      width="1em"
      height="1em"
      viewBox="0 0 512 512" // Ensures the entire icon is visible
      {...rest}
      className={`w-full h-auto ${className}`}
    >
      <path fill="#eceff1" d="M64 64h384v384H64z" data-original="#eceff1" />
      <path
        fill="#cfd8dc"
